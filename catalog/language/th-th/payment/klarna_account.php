<?php
// Text
$_['text_title']				= 'บัญชี Klarna - จ่ายตั้งแต่ %s/เดือน';
...
$_['text_information']			= 'ข้อมูลบัญชีผู้ใช้ Klarna';
$_['text_additional']			= 'บัญชี Klarna ต้องการข้อมูลเพิ่มเติมก่อนที่จะสามารถดำเนินการตามคำสั่งซื้อของคุณ.';
$_['text_male']					= 'ชาย';
$_['text_female']				= 'หญิง';
$_['text_year']					= 'ปี';
$_['text_month']				= 'เดือน';
$_['text_day']					= 'วัน';
$_['text_payment_option']		= 'ตัวเลือกการชำระเงิน';
$_['text_single_payment']		= 'จ่ายครั้งเดียว';
...
$_['error_address_match']		= 'ที่อยู่การชำระเงินและจัดส่งต้องตรงกันถ้าหากคุณต้องการชำระเงินโดยใช้ Klarna';
